...
public class MakeAppointmentListAdapter extends RecyclerView.Adapter<MakeAppointmentListAdapter.MyViewHolder> {
    ...
    public MakeAppointmentListAdapter(Context context, List<ScheduleItem> list, MyAdapterListener myAdapterListener) {
